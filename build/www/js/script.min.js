    ...
    BonziData = {
        ...
        event_list_joke_open: [
            [
                ...
                { type: "text", text: '"Haha! look at the stupid {COLOR} monkey telling jokes!" Fuck you. It isn\'t funny anyway because of you.', say: "Hah hah! Look at the stupid {COLOR} monkey telling jokes! Fuck you. It isn't funny anyway because of you." },
            ...
            [
                ...
                { type: "text", text: "No?" },
                { type: "text", text: "Then I don't care. Do whatever the hell you want, because it's your choice." },
            ],
            [{ type: "text", text: "Senpai, {NAME} wants me to tell a joke!" }],
            [{ type: "text", text: "Time for whatever stupidly fucking terrible jokes the creator of this site wrote." }],
        ],
        event_list_joke_mid: [
            [
            ...
            [
                { type: "text", text: "Why do they call this HTML HyperText?" },
                { type: "text", text: "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA" },
            ...
            [
                ...
                { type: "text", text: "That question is likely a riddle, and a common answer is literally laundry." },
            ],
            [
                { type: "text", text: "What type of water won't freeze?" },
                { type: "text", text: "Your mother's." },
            ],
            [   { type: "text", text: "The megan. This was really a fucking stupid joke." },
                { type: "text", text: "No, Seriously." },
            ],
            [
            ...
            [
                ...
                { type: "text", text: "I literally have no answer." },
            ],
            [
                { type: "text", text: "Why do we call money bread?" },
                { type: "text", text: "Because we knead it!" },
                { type: "text", text: "That was ancient, you know." },
            ],
            [
                { type: "text", text: "What is a cow that eats grass?" },
                { type: "text", text: "Crows!" },
                { type: "text", text: "I literally do not even know at this point." },
                { type: "text", text: "Also, I'm a comedic genius, I know." },
            ],
        ],
        event_list_joke_end: [
            [
                { type: "text", text: "You know {NAME}, a good friend laughs at your jokes even when they're not so funny." },
                { type: "text", text: "And you fucking suck." },
            ...
            [
                ...
                { type: "text", text: "Ok, you know what? this is literally starting to get fucking boring right now." },
            ],
            [
                { type: "text", text: "Don't judge me on my sense of humor alone." },
                { type: "text", text: "Help! I'm being oppressed!" },
                { type: "text", text: "Do I even have to fucking question myself now?" },
            ],
        ],
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_klaskycsupo = [
        { type: "text", text: "Klasky Csupo!" },
        { type: "text", text: "Ding!" },
        { type: "text", text: "Blalalalalelalelaelop!" },
        { type: "text", text: "Quack 🦆, Quack 🪿, Boing!" },
        ]);
